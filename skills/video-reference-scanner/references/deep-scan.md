...
5. Inventariar texto/marca, utilería, vestuario, grafismos, efectos visibles y estados, con rangos, entradas y salidas. Primero registrar qué existe; decidir qué cambia o se conserva pertenece a la adaptación posterior, incluso si el recurso parece difícil de producir.
...
Consolidar eventos y capas siguiendo [source-reading.md](source-reading.md). Revisar por separado información visual, acción/interacción, cámara, montaje, grafismos/efectos, audio y sincronía: cubrir una dimensión no completa las demás. Mantener las limitaciones del medio de análisis separadas de las limitaciones del futuro generador.
